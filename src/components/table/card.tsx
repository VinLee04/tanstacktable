...
// Variants
const cardVariants = cva('flex flex-col items-stretch text-card-foreground rounded-sm', {
  variants: {
    variant: {
...
const cardContentVariants = cva('grow p-5', {
  variants: {
    variant: {
      default: '',
      accent: 'bg-card rounded-t-sm [&:last-child]:rounded-b-sm',
    },
  },
  defaultVariants: {
    variant: 'default',
...
const cardFooterVariants = cva('flex items-center px-5 min-h-14', {
  variants: {
    variant: {
      ...
      accent: 'bg-card rounded-b-sm mt-[2px]',
    },
  },
  defaultVariants: {
    variant: 'default',
